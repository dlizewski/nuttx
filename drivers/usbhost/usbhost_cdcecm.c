...
static const struct usbhost_id_s g_id[] =
{
  ...
  {
    USB_CLASS_VENDOR_SPEC,  /* base - Vendor Specific */
    USB_CLASS_VENDOR_SPEC,  /* subclass - Vendor Specific */
    CDC_PROTO_NONE,         /* proto - No class specific protocol */
    0x0bda,                 /* vid - Realtek Semiconductor Corp */
    0x8153                  /* pid - RTL8153 Gigabit Ethernet Adapter */
  }
};
...
static int cdcecm_transmit(struct usbhost_cdcecm_s *priv)
{
  ...
  cdcecm_print_packet("TX", priv->bulkoutbuf, priv->netdev.d_len);
